...
| `template/14-day-challenge-abc.md` | ทดลองทำ ABC (Digital Product + Content + จ๊อบ) 14 วัน |
...
### Phase 4: ทดสอบ
- เสนอ 3 Mini-experiment (จาก `scripts/mini-experiments.md` หรือ `template/14-day-challenge-abc.md`)
