...
พิมพ์ `/ikigai` ตามด้วยสิ่งที่ต้องการใน Claude Code:
...
```
/ikigai ช่วยถามคำถามสะท้อนตัวเอง
...
| 🧪 **ABC Challenge 14 วัน** | `template/14-day-challenge-abc.md` | Digital Product + Content + จ๊อบ | Phase 3 |
...
│   └── 14-day-challenge-abc.md    ← ABC Challenge 14 วัน
│
...
git clone https://github.com/hartkitsak/ikigai.git "$env:USERPROFILE\.claude\skills\ikigai"
```

จากนั้นพิมพ์ `/ikigai` ใน Claude Code
